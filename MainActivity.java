...
public class MainActivity extends AppCompatActivity {
    ...
    //location request is config file for all settings related to fusedlocationprovider
    LocationRequest locationRequest;

    LocationCallback locationCallBack;

    //using APIs for location service. the majority of app functions using this class.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_showWayPointList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(MainActivity.this,ShowSavedLocation.class);
                startActivity(i);
            }
        });
    ...
    private void updateGPS() {
        ...
        //GET THR CURRENT LOCATION FROM THE FUSED CLIENT
        //UPDATE THE UI-i.e. Set all the properties in their associated text view item.
